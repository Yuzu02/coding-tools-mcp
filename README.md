...
An optional `semantic` extension adds six read-only symbol, definition,
implementation, reference, and diagnostic tools through exact-pinned Serena
1.5.3. When explicitly enabled and available at startup the catalog contains 32 tools; the default remains
